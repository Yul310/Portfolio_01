...
const Home = () => {
    return (
        <div name='home' className='w-full h-screen bg-[#343434] '>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full '>
                ...
                <p className=' text-[#909090] py-4 max-w-700 text-md'> who has an architecture background and loves problem solving and building, structuring digital experiences. </p>
