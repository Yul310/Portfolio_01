...
const Contact = () => {
    return (
        ...
        <div name='contact' className="w-full  bg-[#343434] flex justify-center items-center p-4  my-[100px]">
            <form method='post' action="https://getform.io/f/9359366a-3e00-493d-a5b2-cbf3bb960028" className='flex flex-col max-w-[700px] w-full '>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-[#F8FF24] text-white'>
                        Contact
                    </p>
                ...
                <button className=" text-2xl rounded-md text-white border-2 hover:bg-[#F8FF24] hover:border-[#F8FF24] hover:text-[#343434] px-4 my-8 mx-auto flex items-center">Submit</button>
            </form>
